 ...
 */
class BotonClase(val texto: String, val colorFondo: String, val colorTexto: String) {
    ...
    companion object {
        ...
        fun crearBotonDefault(texto: String): BotonClase {
            return BotonClase(texto, "#CCCCCC", "#333333") // Gris y negro
        }

        // Método de fábrica para un botón primario
        fun crearBotonPrimario(texto: String): BotonClase {
            return BotonClase(texto, "#007BFF", "#FFFFFF") // Azul y blanco
        }

        // Método de fábrica para un botón de advertencia
        fun crearBotonAdvertencia(texto: String): BotonClase {
            return BotonClase(texto, "#FFC107", "#333333") // Amarillo y negro
        }
    }
}

fun ejercicio4CompanionObjectFactoryMethod() {
    val botonAceptar = BotonClase.crearBotonPrimario("Aceptar")
    val botonCancelar = BotonClase.crearBotonDefault("Cancelar")
    val botonBorrar = BotonClase.crearBotonAdvertencia("Eliminar")
    ...
    val botonManual = BotonClase("Manual", "#000000", "#FFFFFF")
    botonManual.click()
}
...
fun Documento.Companion.crearDocumentoDePlantilla(nombrePlantilla: String): Documento {
    ...
    return when (nombrePlantilla.lowercase(getDefault())) {
